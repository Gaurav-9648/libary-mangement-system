...
class Library:
    ...
    def __init__(self,root):
        ...
        def DisplayData():
           ...
           self.txtFrameDetail.insert(END,"\t"+MemberType.get()+"\t\t"+Ref.get()+"\t"+BookTitle.get()+"\t" + Title.get()+"\t"+FirstName.get() +"\t"+Address.get()+"\t\t"+BookTitle.get()+"\t"+PostCode.get()+"\t"+PhoneNo.get()+"\t"+Author.get()+"\t"+DateofIssued.get()+"\t\t"+DueDate.get()+ReturnDate.get()+ "\n")
        ...
        def Receipt():
            ...
            self.txtDisplayR.insert(END,'Phone No: \t\t' + PhoneNo.get() + "\n")
            self.txtDisplayR.insert(END,'Author: \t\t' + Author.get() + "\n")
            self.txtDisplayR.insert(END,'Date of Issued: \t\t' + DateofIssued.get() + "\n")
            self.txtDisplayR.insert(END,'Due Date: \t\t' + DueDate.get() + "\n")
            self.txtDisplayR.insert(END,'Return Fine: \t\t' + ReturnFine.get() + "\n")
        ...
        self.lblTitle =Label(TitleFrame,width=39,font=('Times New Roman',40,'bold'),text="\tLibrary Management System\t",bg="blue",fg='black',padx=12)
        self.lblTitle.grid()
        ...
        DataFrameLEFT =LabelFrame(DataFrame,bd=10,width=900,height=300,padx=20,relief=RIDGE,font=('Times New Roman',12,'bold'),text="Library Membership Info:",fg="blue")
        DataFrameLEFT.pack(side=LEFT)

        DataFrameRIGHT =LabelFrame(DataFrame,bd=10,width=450,height=300,padx=20,relief=RIDGE,font=('Times New Roman',12,'bold'),text="BookDetails",fg="red")
        ...
        self.cboMemberType['value']=('--select--','Student','Lecturer','AdminStaff')
        ...
        ListofBooks = ['Self Help','Game Design','Programming in C','Programming in Python','Swami Vivekananda','PythonDeveloper']
        ...
        def SelectedBook(evt):
            ...
            if (w == "Self Help"):
                BookID.set("ISBN 9788183225090")
                BookTitle.set("Belive In Yourself")
                Author.set("Dr.Joseph Murphy")

                ReturnFine.set("Rs.10")
                Price.set("Rs.94")
                Receipt()
            ...
            elif(w == "Programming in Python"):
            	 BookID.set("ISBN-13 9798741059081")
            	 BookTitle.set("Python for Beginner")
            	 Author.set("Dr. Mehul Patel")
            ...
            elif(w == "Swami Vivekananda"):
            	 BookID.set("ISBN 9789350482643")
            	 BookTitle.set("Biography and Autography")
            	 Author.set("Deokinandan Gautam")
        ...
        #=======================================Button=========================================================================
        self.btnDisplayData=Button(ButtonFrame,text="DISPLAYDATA",fg="Crimson",bg="yellow",font=('Times New Roman',12,'bold'),width=30,bd=4,command=DisplayData)
        self.btnDisplayData.grid(row=0,column=1)

        self.btnDelete=Button(ButtonFrame,text="DELETE",fg="Crimson",bg="skyblue",font=('Times New Roman',12,'bold'),width=30,bd=4,command=Delete)
        self.btnDelete.grid(row=0,column=0)

        self.btnReset=Button(ButtonFrame,text="RESET",fg="Crimson",bg="gray",font=('Times New Roman',12,'bold'),width=30,bd=4,command=Reset)
        self.btnReset.grid(row=0,column=2)

        self.btnExit=Button(ButtonFrame,text="EXIT",fg="Crimson",bg="orange"
                            ,font=('Times New Roman',12,'bold'),width=30,bd=4,command=Exit)
